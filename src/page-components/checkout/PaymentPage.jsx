                        ...
                        <div className="w-0 flex-grow-1">
                          <div>
                            ...
                            <>
                              ...
                              নিচের বক্স এ যে নাম্বার থেকে টাকা পেমেন্ট করেছেন
                              সেই নাম্বার অথবা ট্রাঞ্জেকসন আইডি দিন
                            </>
                            {/* )} */}
                          </div>
                          <div className="row">
                            <div className="col-xl-7">
                              <div className="input-text-sm mt-3">
                                <Input
                                  value={payment_method.transection_id_number}
                                  onChange={(e) => {
                                    setPaymentMethod({
                                      ...payment_method,
                    ...
                    <div className="">
                      ...
                      <div className="row">
                        <div className="col-12">
                          <button
                            disabled={isBkashLoading || active === null}
