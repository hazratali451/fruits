			...
			<div className="py-5">
				<div className="container py-md-5">
                  ...
                  />
								...
								<p>
									You can order without login, click the "Checkout as
									Guest" button below to order without login. And click
									the "Checkout After Login" button below to order by
									login.
									{/* <Language
										data={{
											en: 'You can order without login, click the "Checkout as
									Guest" button below to order without login. And click
									the "Checkout After Login" button below to order by
									login.',
